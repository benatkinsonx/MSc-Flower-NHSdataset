...
def create_log_reg_and_instantiate_parameters(penalty=None, epsilon=EPSILON, data_norm=DATA_NORM):
    """Helper function to create a DiffPrivLib LogisticRegression model."""
    
    if data_norm is None:
        # For unscaled GBSG medical data
        data_norm = 20.0  # Based on medical domain knowledge
